...
class MainViewController: UIViewController {
    ...
    @objc func action(){
        ...
        let buttonXPlacement = myButton.centerXAnchor.constraint(equalTo: self.view.centerXAnchor)
        let buttonYPlacement = myButton.centerYAnchor.constraint(equalTo: self.view.centerYAnchor)
        let newButtonCons: [NSLayoutConstraint] = [buttonHeight, buttonWidth, buttonXPlacement, buttonYPlacement]
